...
{
	int size1;
	printf("Please input the value of size1:");
	scanf("%d",&size1);
	int a[size1];
	printf("Please input the content of the array a:");
	for(int i=0;i<size1;i++)
	scanf("%d",a+i);
	int size2;
	printf("Please input the value of size2:");
	scanf("%d",&size2);
	int b[size2];
	printf("Please input the content of the array b:");
